...
function fetchJsonAndApplyToDom(path) {
    fetch(path, {
        ...
        .then(content => {
            ...
            var totalDownloads = getTotalDownloadsFromSpigot(resources);
...
function getTotalDownloadsFromSpigot(resources) {
    var total = 0;
